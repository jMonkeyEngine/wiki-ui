...
image:https://github.com/jMonkeyEngine/wiki-ui/workflows/Build%20UI/badge.svg[Build UI Status Badge, 175, 25]
image:https://github.com/jMonkeyEngine/wiki-ui/workflows/Tagged%20Release/badge.svg[Tagged Release Status Badge, 175, 25]

jMonkeyEngine Admin must push an semantic versioned annotated tag to any branch to trigger the release of a new UI. This will also trigger the workflow of the jMonkeyEngine wiki. The wiki always pulls in the "latest" release.
