...
jMonkeyEngine Admin must push an annotated tag to any branch to trigger the release of a new UI. This will also trigger the workflow of the jMonkeyEngine wiki. The wiki always pulls in the "latest" release. 
